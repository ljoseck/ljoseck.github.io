var cloneSets = Ext.create('Ext.data.Store', {  data: [
          ...
          {'1':"Infinite Chess", '2':"JavaScript", '3':"2022", '4':"2022", '5': "Personal Project",'6':764},
          {'1':"Lost Gems of Condor", '2':"JavaScript", '3':"2019", '4':"Present", '5': "Personal Project",'6':11002},
...
function projectRenderer(val) {
    if (val != null) {
		if(val == "Lost Gems of Condor")
			return "<a href='https://lostgemsofcondor.itch.io/lost-gems-of-condor'>" + val + "</a>";
